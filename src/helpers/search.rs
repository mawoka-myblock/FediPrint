...
use meilisearch_sdk::{Index, errors::Error, SearchResults};
...
pub async fn search(query: &str, page: i64, page_size: i64, index: &Index) -> Result<SearchResults<MsModel>, Error> {
    Ok(index.search()
        .with_query(query)
